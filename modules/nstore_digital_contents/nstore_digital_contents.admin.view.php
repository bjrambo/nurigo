...
class nstore_digital_contentsAdminView extends nstore_digital_contents
{
	...
	function dispNstore_digital_contentsAdminItemList()
	{
		...
		if(Context::get('nproduct_srl'))
		{
			Context::set('nproduct_srl', Context::get('nproduct_srl'));
		}
	...
	function dispNstore_digital_contentsAdminManageContents()
	{
		...
		if($output->data)
		{
			...
			{
				Context::set('extra_vars', unserialize($output->data->extra_vars));
			}
		}
	...
	function dispNstore_digital_contentsAdminInsertConfig()
	{
		...
		if($nstore_digital_contents_config)
		{
			Context::set('config', $nstore_digital_contents_config);
		}
