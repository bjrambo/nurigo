<?php
define('INIPAY_HOME', _XE_PATH_.'files/epay/iniescrow');
define('INIPAY_LOGDIR', _XE_PATH_.'files/epay/iniescrow/log');
define('INIPAY_KEYDIR', _XE_PATH_.'files/epay/iniescrow/key');

class iniescrow extends EpayPlugin 
{
	var $plugin_info;
	...
	function pluginInstall($args) 
	{
		...
		// copy files
		FileHandler::copyFile(_XE_PATH_.'modules/epay/plugins/iniescrow/.htaccess',sprintf(_XE_PATH_."files/epay/%s/.htaccess",$args->plugin_srl));
		FileHandler::copyFile(_XE_PATH_.'modules/epay/plugins/iniescrow/readme.txt',sprintf(_XE_PATH_."files/epay/%s/readme.txt",$args->plugin_srl));
		FileHandler::copyFile(_XE_PATH_.'modules/epay/plugins/iniescrow/key/pgcert.pem',sprintf(_XE_PATH_."files/epay/%s/key/pgcert.pem",$args->plugin_srl));
	}
...
/* Location: ./modules/epay/plugins/iniescrow/iniescrow.plugin.php */
