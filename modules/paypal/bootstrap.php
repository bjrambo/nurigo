...
$clientId = $oPaypalModuleConfig->client_id;
$clientSecret = $oPaypalModuleConfig->api_secret;
$mod = $oPaypalModuleConfig->endpoint;
...
$apiContext = getApiContext($clientId, $clientSecret, $mod);
return $apiContext;
 ...
 */
function getApiContext($clientId, $clientSecret, $mod)
{
    // #### SDK configuration
