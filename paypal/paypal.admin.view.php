 ...
 * @class  paypalAdminView
 * @author NURIGO(contact@nurigo.net)
 * @brief  paypalAdminView
 */ 
class paypalAdminView extends paypal
{
	/**
	 ...
	 */
	function dispPaypalAdminInsert() 
	{
	 ...
	 */
	function dispPaypalAdminInsertModInst() 
	{
		// get the skin list
		$oModuleModel = &getModel('module');
	 ...
	 **/
	function dispPaypalAdminSkinInfo() 
	{
...
/* End of file paypal.admin.view.php */
/* Location: ./modules/paypal/paypal.admin.view.php */
